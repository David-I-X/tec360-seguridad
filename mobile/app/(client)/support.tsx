...
export default function SupportScreen() {
  ...
  const handleEmail = () => {
    Linking.openURL('mailto:soporte@tec-360.tech?subject=Soporte%20Tec360&body=' +
      encodeURIComponent(`Hola, soy ${user?.full_name || 'un usuario'} (${user?.phone || ''}).\n\n`));
  };
      ...
      <ScrollView contentContainerStyle={{ paddingBottom: 120 }}>
        ...
        <TouchableOpacity style={styles.channelCard} onPress={() => Linking.openURL('https://wa.me/573052156601')} activeOpacity={0.7}>
          ...
          <View style={{ flex: 1 }}>
            ...
            <Text style={styles.channelSub}>Respuesta rápida • Horario extendido</Text>
          </View>
          <Ionicons name="chevron-forward" size={18} color="#555872" />
        </TouchableOpacity>

        <TouchableOpacity style={styles.channelCard} onPress={handleEmail} activeOpacity={0.7}>
        ...
        <TouchableOpacity style={styles.channelCard} onPress={handleCall} activeOpacity={0.7}>
        ...
        {/* Quick Message */}
        <Text style={[styles.sectionTitle, { marginTop: 24 }]}>ENVIAR MENSAJE RÁPIDO</Text>

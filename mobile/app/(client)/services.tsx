...
const statusConfig: Record<string, { label: string; color: string; bg: string }> = {
  ...
  quoted:      { label: 'Cotizado',     color: '#6366f1', bg: 'rgba(99,102,241,0.15)' },
  assigned:    { label: 'Asignado',     color: '#3b82f6', bg: 'rgba(59,130,246,0.15)' },
  en_route:    { label: 'En camino',    color: '#2563eb', bg: 'rgba(37,99,235,0.15)' },
    ...
    <View style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <TouchableOpacity
          ...
          activeOpacity={0.8}
        >
          <LinearGradient colors={['#3b82f6', '#6366f1']} style={styles.newButton} start={{ x: 0, y: 0 }} end={{ x: 1, y: 0 }}>
        ...
        ListEmptyComponent={
          <View style={styles.emptyContainer}>
            ...
            <TouchableOpacity onPress={() => router.push('/(client)/new-service' as any)} activeOpacity={0.8}>
              <LinearGradient colors={['#3b82f6', '#6366f1']} style={styles.emptyButton} start={{ x: 0, y: 0 }} end={{ x: 1, y: 0 }}>
...
const styles = StyleSheet.create({
  ...
  headerTitle: { color: '#f8fafc', fontSize: 28, fontWeight: '800', marginTop: 2 },
  newButton: { width: 48, height: 48, borderRadius: 16, justifyContent: 'center', alignItems: 'center', shadowColor: '#3b82f6', shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.3, shadowRadius: 8, elevation: 8 },
  statsRow: { flexDirection: 'row', gap: 10, paddingHorizontal: 20, marginBottom: 16 },
  statCard: { flex: 1, backgroundColor: 'rgba(30,41,59,0.6)', borderRadius: 16, padding: 14, alignItems: 'center', borderWidth: 1, borderColor: 'rgba(71,85,105,0.2)' },
  statNumber: { color: '#f8fafc', fontSize: 22, fontWeight: '800' },
  statLabel: { color: '#64748b', fontSize: 11, marginTop: 2 },
  filterRow: { paddingHorizontal: 20, marginBottom: 12, maxHeight: 40 },
  filterChip: { paddingHorizontal: 16, paddingVertical: 8, borderRadius: 20, backgroundColor: 'rgba(30,41,59,0.6)', borderWidth: 1, borderColor: 'rgba(71,85,105,0.3)' },
  ...
  emptySubtitle: { color: '#64748b', fontSize: 14, marginTop: 4, marginBottom: 24 },

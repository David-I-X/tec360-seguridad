...
const styles = StyleSheet.create({
  ...
  serviceTitle: { color: '#f0f0f5', fontSize: 22, fontWeight: '800', marginBottom: 10 },
  infoRow: { flexDirection: 'row', alignItems: 'center', gap: 8, marginBottom: 8 },
  infoText: { color: '#8b8fa3', fontSize: 14, flex: 1 },
  clientCard: { backgroundColor: 'rgba(10,14,28,0.8)', borderRadius: 18, padding: 16, marginTop: 16, borderWidth: 1, borderColor: 'rgba(80,60,160,0.2)' },

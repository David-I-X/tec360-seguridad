...
const styles = StyleSheet.create({
  ...
  clientCard: { backgroundColor: 'rgba(10,14,28,0.8)', borderRadius: 18, padding: SPACING.lg, marginBottom: SPACING.md, borderWidth: 1, borderColor: COLORS.border },
  ...
  actionGradient: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: SPACING.md, paddingVertical: 18, borderRadius: 18 },
  actionEmoji: { fontSize: 22 },
  actionText: { color: '#fff', fontSize: FONTS.sizes.lg, fontWeight: '800' },
  completedBanner: { alignItems: 'center', marginTop: SPACING.sm, padding: SPACING.lg, backgroundColor: 'rgba(34,197,94,0.1)', borderRadius: 18, borderWidth: 1, borderColor: 'rgba(34,197,94,0.2)' },

...
Revision ID: 4181c55ae5fe
Revises: 
Create Date: 2026-01-28 22:00:55.327433
...
def upgrade() -> None:
    ...
    sa.Column('service_type', sa.Enum('gps_installation', 'gps_maintenance', 'alarm_installation', 'alarm_maintenance', 'camera_installation', 'camera_maintenance', 'other', name='servicetype'), nullable=False),
    sa.Column('status', sa.Enum('pending', 'assigned', 'in_progress', 'completed', 'cancelled', name='servicestatus'), nullable=False),
    ...
    sa.Column('service_location', geoalchemy2.types.Geometry(geometry_type='POINT', srid=4326, dimension=2, from_text='ST_GeomFromEWKT', name='geometry'), nullable=True),
    sa.Column('created_at', sa.DateTime(), nullable=False),
    sa.Column('updated_at', sa.DateTime(), nullable=False),
    ...
    # op.create_index('idx_services_service_location', 'services', ['service_location'], unique=False, postgresql_using='gist')
    op.create_index(op.f('ix_services_id'), 'services', ['id'], unique=False)
    # PostGIS system tables preserved
...
def downgrade() -> None:
    ...
    op.drop_index('idx_services_service_location', table_name='services', postgresql_using='gist')

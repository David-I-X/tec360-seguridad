        ...
        <>
            <div className="space-y-6">
                ...
                <a
                    ...
                    className="block"
                >
                    <GlassCard className="p-4 border-green-500/20 hover:border-green-500/40 transition-colors cursor-pointer group">
                        <div className="flex items-center gap-3">
                            ...
                            <div className="flex-1">
                                <p className="text-sm font-semibold group-hover:text-green-400 transition-colors">¿Necesitas ayuda?</p>
                                <p className="text-xs text-muted-foreground">Contacta soporte por WhatsApp</p>
                            </div>
